...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>rn', vim.lsp.buf.rename, '[v]iew [r]e[n]ame float')
  nmap('<leader>ca', vim.lsp.buf.code_action, '[c]ode [a]ctions')
  nmap('<leader>gd', vim.lsp.buf.definition, '[g]oto [d]efinition')
  nmap('<leader>gD', vim.lsp.buf.type_definition, 'Type [D]efinition')
  nmap('<leader>rr', require('telescope.builtin').lsp_references, '[v]iew [r]eferences')
  ...
  nmap('<leader>dd', vim.lsp.buf.declaration, '[g]oto [D]eclaration')
